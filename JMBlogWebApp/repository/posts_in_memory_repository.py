...
class PostsInMemoryRepository(PostsRepository):
    def __init__(self):
        self._db = [BlogPost(uuid.uuid4(), datetime.datetime.now().strftime("%Y-%B-%d %H:%M:%S"), "FirstTitle", "FirstAuthor", "Lorem Ipsum is simply dummy , \
        ...
        BlogPost(uuid.uuid4(), datetime.datetime.now().strftime("%Y-%B-%d %H:%M:%S"),"SecondTitle", "SecondAuthor", "Lorem Ipsum is simply dummy text of the, \
        ...
        BlogPost(uuid.uuid4(), datetime.datetime.now().strftime("%Y-%B-%d %H:%M:%S"),"ThirdTitle", "ThirdAuthor", "Lorem Ipsum is simply dummy text of the printing , \
