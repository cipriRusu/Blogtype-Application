...
class PostsInMemoryRepository(PostsRepository):
    def __init__(self):
        ...
        self._db[0].stamp.post_id = 'f9c3a576-28bc-4b63-931d-04d6488d2f0d'
        self._db[0].stamp.creation_time = '2019-09-03 19:40:33'

        self._db[1].stamp.post_id = 'daca57d1-c180-4e0a-8394-f5c95a5d5f23'
        self._db[1].stamp.creation_time = '1991-03-02 12:30:44'

        self._db[2].stamp.post_id = 'a656f973-5b82-462d-aff7-8d2c6c3e4fa2'
    ...
    def get_by_id(self, index):
        for element in self._db:
            if element.stamp.post_id == str(index):
                return element
