...
CREATE_DATABASE_SCRIPT = "CREATE DATABASE posts"

#CREATE_DATABASE_SCRIPT = "CREATE DATABASE IF NOT EXISTS posts" #invalid syntax?
...
CHECK_AUTHOR_SCRIPT = "SELECT DATATYPE FROM INFORMATION_SCHEMA.COLUMNS\
WHERE TABLE_NAME='posts' AND COLUMN_NAME='author'"

CREATE_FULL_DATABASE = [CREATE_DATABASE_SCRIPT, CREATE_USERS_SCRIPT,\
                        CREATE_POSTS_SCRIPT, CREATE_ADMIN_SCRIPT]
