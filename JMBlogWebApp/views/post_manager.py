...
@decorators.config_check
@decorators.inject
def remove_item(current_index, current_database: services.DATA_SOURCE):
...
@decorators.config_check
@decorators.inject
def update_item(current_index, current_database: services.DATA_SOURCE):
